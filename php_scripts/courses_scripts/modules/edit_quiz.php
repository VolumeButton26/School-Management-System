<?php
    ...
    if (isset($_POST['edit-module-button'])) {
        sql("UPDATE modules_quizzes_main SET Content = '$content', Points = 0, Start_date = '$start_date_formatted', Due_date = '$due_date_formatted', No_of_tries = $no_of_tries WHERE Module_ID = $module_id");
    }
